...
# Create knn classification for Ale and IPA
ale_ipa_classification <- knn(ipas_and_ales_train[,c(3,4)], 
                              ipas_and_ales_test[,c(3,4)],
                              ipas_and_ales_train$Style,
                              prob=TRUE, 
                              k=optimal_k) # K determined by above comment

# Create confusion matrix based on ale_ipa_classification
ale_ipa_cm <- confusionMatrix(table(ipas_and_ales_test$Style, 
                                    ale_ipa_classification))
